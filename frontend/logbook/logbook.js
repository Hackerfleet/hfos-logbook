...
class LogbookCtrl {
    constructor($scope, $compile, user, ObjectProxy, moment, notification, NgTableParams) {
        ...
        this.tableParams = new NgTableParams({}, {
            getData: function (params) {
                ...
                return self.op.search('logbookentry', filter, '*', null, false, limit, skip).then(function (msg) {
                    let logbookentries = msg.data.list;
                    params.total(msg.data.size); // recal. page nav controls
                    console.log("LOGBOOK_TABLE2:", params);
    ...
    setup_swimlane() {
        ...
        let randomData = function () {
            ...
            var generateRandomWorkItems = function () {
                ...
                for (var i = 0; i < laneCount; i++) {
                    var dt = new Date(2019, startMonth, startDay);
        ...
        let lane_area = d3.select('#timeline');

        console.log('LANE AREA:', lane_area);
